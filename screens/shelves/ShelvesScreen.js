          ...
          <Button onPress={() => navigation.goBack()} type="back" />
                ...
                {/* --- BOUTON  Meditatoin --- */}
                  <PulsingButton
                    ...
                    onPress={() => {console.log("ok lien vers MeditationHome fonctionnel");navigation.navigate("MeditationHome");}}
                        // children="Etagère"
                  />
                ...
                {/* --- BOUTON Respiration --- */}
                  <PulsingButton
                    ...
                    onPress={() => {console.log("ok lien vers RespirationHome fonctionnel");navigation.navigate("RespirationHome");}}
                        // children="Carte"
                  />
                 ...
                 {/* --- BOUTON Flashcard --- */}
                  <PulsingButton
                    ...
                    onPress={() => {console.log("ok lien vers Flashcard fonctionnel");navigation.navigate("flashcard");}}
                        // children="Carte"
                  />
                  ...
                  <PulsingButton
                    ...
                    onPress={() => {console.log("ok lien vers ChatScreen fonctionnel");navigation.navigate("ChatScreen");}}
                        // children="Carte"
                  />
